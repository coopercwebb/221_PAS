...
void TestConstructorRender() {
    ...
    if (inimg.height() == 4 && inimg.width() == 3) {
        ...
        cout << "Determining physical node dimensions of non-carved image... ";
        unsigned int precarvex = list3x4.GetDimensionX();
        unsigned int precarvey = list3x4.GetDimensionY();
        cout << "done." << endl;

        cout << "Expected horizontal dimension: 3" << endl;
        cout << "Your horizontal dimension: " << precarvex << endl;

        cout << "Expected vertical dimension: 4" << endl;
        cout << "Your vertical dimension: " << precarvey << endl;
