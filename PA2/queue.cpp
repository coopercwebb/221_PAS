 ...
 *  the caller. Unlike Dequeue(), this operation does (conceptually!) not alter
 * the Queue; however, you may need to alter the internal representation of the
 * Queue. You may assume that this function is only called when the Queue is
 * non-empty.
 *
 *  NOTE: This function should have O(1) behavior over n operations!
 *
