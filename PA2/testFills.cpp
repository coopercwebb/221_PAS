...
TEST_CASE("fill::basic stripe dfs", "[weight=1][part=fill]") {
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-dfsstripe.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic stripe bfs", "[weight=1][part=fill]") {
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-bfsstripe.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic border dfs", "[weight=1][part=fill]") {
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-dfsborder.png");
    REQUIRE(result == expected);
...
TEST_CASE("fill::basic border bfs", "[weight=1][part=fill]") {
    ...
    PNG expected;
    expected.readFromFile("images-soln/ex-bfsborder.png");
    REQUIRE(result == expected);
